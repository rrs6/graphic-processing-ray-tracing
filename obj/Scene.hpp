...
public:
    ...
    RGB checkIntersections(const vector<Sphere> &spheres, const vector<Plan> &planes, const vector<TriangleMesh> &meshs, Vector &ray, const Point &rayO, const vector<Light> &lights, int depth);
